...
Date:      2006-11-14
Version:   0.7.3
Copyright: (c) 2003-2005 Pfizer, (c) 2006 Gregory R. Warnes.
...
__version__ = "0.7.3"
ident = "$Id: fpconst.py 356 2006-11-15 17:45:32Z warnes $"
...
def _exponent(dval):
    """Extract the exponent bits from a double-precision floating
    point value.

    Note that for normalized values, the exponent bits have an offset
    of 1023. As a consequence, the actual exponent is obtained
